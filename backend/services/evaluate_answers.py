...
def display_evaluation_accuracy():
    ...
    # Connect to CORRECT database - ai-evaluation-system
    try:
        client = MongoClient('mongodb://localhost:27017/')
        db = client['ai-evaluation-system']  # FIXED DATABASE NAME
...
def display_questions_and_files():
    """
    Display questions and files from the database
    """
    print("📋 DATABASE CONTENT DISPLAY")
    print("=" * 70)
    ...
    for i, file in enumerate(files, 1):
        ...
        # Try to read and display text file content
    ...
    print("\n" + "=" * 70)
    print(f"📊 SUMMARY: {len(questions)} questions, {len(files)} files")
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    print("3. 🔍 Display Database Content")
    print("4. 📋 Show Questions & Files")
    ...
    try:
        ...
        if choice == "1":
            ...
            try:
                client = MongoClient('mongodb://localhost:27017/')
                db = client['ai-evaluation-system']  # FIXED DATABASE
